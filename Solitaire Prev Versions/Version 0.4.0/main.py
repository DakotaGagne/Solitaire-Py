...
GAME_MODES = ["Klondike", "Spider", "Freecell"]
...
def main_loop():
    ...
    while running:
        ...
        mouse.leftClickState = pygame.mouse.get_pressed()[0]
        ...
        # Mouse Handling
        if mouse.leftClickState and not prev_mouse_state:
            click = "Down"
        elif not mouse.leftClickState and prev_mouse_state:
            click = "Up"
        else:
            click = "None"
        prev_mouse_state = mouse.leftClickState
